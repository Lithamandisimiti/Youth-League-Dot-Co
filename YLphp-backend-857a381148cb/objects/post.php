...
class POST{
    ...
    public function create_post(){
        try{
            ...
            INSERT INTO MEDIA SET post_id=@id, media_url=:media_url, media_song=:media_song, media_artists=:media_artists, media_album=:media_album;
            ...
            $media_album = htmlspecialchars(strip_tags($this->media_album));
            $media_song = htmlspecialchars(strip_tags($this->media_song));
            $media_artists = htmlspecialchars(strip_tags($this->media_artists));
            ...
            $stmt->bindParam(':media_song', $media_song);
            $stmt->bindParam(':media_album', $media_album);
            $stmt->bindParam(':media_artists', $media_artists);
    ...
    public function get_posts($from_record_num, $records_per_page) {
        ...
        try{
	        $query = "SELECT p.post_id as post_id, p.post_title as title, p.post_description as description, p.post_status as status, 
						p.post_type as type, p.post_cover_image as cover_image, m.media_url as media_url, m.media_song as song_name, m.media_artists as song_artists, m.media_album as song_album, p.post_location as location, p.post_created as date_time, 

...
class Posts extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={bt}>
        <div className="p-2 pt-0 text-center" style={fs}>
          <span
            className="ion-ios-arrow-thin-left float float-left"
...
class TimelineComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    const id = this.state.isLoggedIn ? this.state.id : -1;
    this.props.posts(PostTypes.CATEGORY, id);
  }
    ...
    return (
      <div className="row">
        ...
        >
          ...
          {isLoggedIn && (
            <GooeyNav orientation="bottom" uploadFrom="category" />
          )}
          {isPostsSuccess && (
